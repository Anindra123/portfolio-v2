    ...
    return (
        ...
        <>
            ...
            <div className='flex flex-row w-screen items-center justify-between h-28 border-b-2  border-violet-300'>
                <p className=' text-2xl text-violet-300  ml-5 no_highlights  flex-1'><a href="/">adb.</a></p>
                <nav className=' text-violet-300  flex-1'>
                    <NavLinks style='inline-block mr-5' parentStyle='hidden no_highlights flex-row justify-end mr-5 md:flex ' />
